      ...
      <AppBar position="static" sx={{ backgroundColor: 'transparent', boxShadow: '0px 0px '}}>
        <Container maxWidth="xl" sx={{ px: { lg: '40px', md: '30px', sm: '20px', xs: '16px' }, m: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Box sx={{ flexGrow: 1, justifyContent: 'center', display: { xs: 'none', md: 'flex',} }}>
            {list.map((list) => (
              <Button key={list.path} onClick={handleCloseNavMenu} sx={{ my: 2, color: '#000', fontFamily:'"Prosto One",system-ui',display:'block', textTransform:'uppercase',fontSize:'16px',margin:'0',padding:'30px 20px',lineHeight:'0px'}}>
